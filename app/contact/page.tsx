        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@uraerotech.com</p>
                    <p className="text-gray-600">support@uraerotech.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Aviation District, City 12345</p>
                  </div>
                </div>
            ...
            <div className="bg-primary-600 text-white rounded-2xl shadow-xl p-8">
              ...
              <p className="mb-4">
                For urgent aircraft repair needs, our emergency team is available around the clock.
              </p>
              <p className="text-xl font-bold">+1 (555) 911-AERO</p>
            </div>
          </div>
        </div>
      </div>
